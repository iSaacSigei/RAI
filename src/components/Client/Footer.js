...
import { FaFacebookF, FaLinkedinIn, FaTwitter, FaTiktok } from 'react-icons/fa'; // Import FaTiktok

const Footer = () => {
  return (
    <footer className="bg-blue-900 text-white py-10">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold">Leading the Way in AI Ethics and Responsibility</h2>
        <div className="mt-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-center sm:text-left mb-8">
        <div>
        ...
        <div>
          ...
          <ul>
            <li><a href="mailto:support@etrom.com" className="no-underline hover:underline">support@etrom.com</a></li>
            <li><a href="tel:+6623991345" className="no-underline hover:underline">+66 2399 1345</a></li>
      ...
      <div className="text-center">
        ...
        <div className="flex justify-center space-x-4 mt-4">
          ...
          <a href="https://tiktok.com" aria-label="TikTok" className="text-white hover:text-gray-400">
